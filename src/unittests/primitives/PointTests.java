...
class PointTests {
	...
	void testAdd() {
		...
		// TC02: Test that result of sun between point and vector is proper
	...
	void testSubtract() {
		...
		// TC11: Test the substract between 2 same points
		assertThrows(IllegalArgumentException.class, () -> p1.subtract(p1),
				"subtract() for parallel vectors does not throw an exception");
	}
	...
	void testDistanceSquared() {
		...
		assertEquals(3, p1.distanceSquared(new Point(2, 3, 4)), 0.000001,
				"ERROR: distanceSquared does not work correctly");

		// =============== Boundary Values Tests ==================
		// TC11: Test if the squared distance from point to itself is 0
		assertEquals(0, p1.distanceSquared(p1), 0.000000001,
		...
		assertEquals(2, p1.distanceSquared(new Point(0, 2, 2)),
	...
	void testDistance() {
		...
		assertEquals(1, p1.distance(new Point(0, 2, 0)),
