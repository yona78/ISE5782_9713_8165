...
class RayTests {
	...
	void testFindClosestPoint() {
		...
		assertEquals(new Point(1, 2, 0),
				...
				"Test when the closesd point is in the middle failed");
		...
		assertEquals(new Point(1, 2, 0),
				...
				"Test when the closesd point is in the beginning failed");
		...
		assertEquals(new Point(1, 2, 0),
				...
				"Test when the closesd point is in the ending failed");
	}
	...
	void findClosestGeoPoint() {
		...
		GeoPoint gA = new GeoPoint(sp, a), gB = new GeoPoint(tr, b), gC = new GeoPoint(sp, c);
		...
		assertEquals(new GeoPoint(tryTr, b), ray.findClosestGeoPoint(lst),
				"The middle point is the closest test failed");
