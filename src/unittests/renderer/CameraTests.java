...
class CameraTests {
	...
	void testConstructRay() {
		...
		assertEquals(new Ray(ZERO_POINT, new Vector(0, -2, -10)), camera.constructRay(3, 3, 1, 0),
				badRay);

		// BV03: 3X3 Center of Left Side (1,0)
		assertEquals(new Ray(ZERO_POINT, new Vector(2, 0, -10)), camera.constructRay(3, 3, 0, 1),
				badRay);

		// BV04: 3X3 Corner (0,0)
		assertEquals(new Ray(ZERO_POINT, new Vector(2, -2, -10)), camera.constructRay(3, 3, 0, 0),
				badRay);
		...
		// BV06: 4X4 Side (0,1)
		assertEquals(new Ray(ZERO_POINT, new Vector(1, -3, -10)), camera.constructRay(4, 4, 1, 0),
				badRay);
