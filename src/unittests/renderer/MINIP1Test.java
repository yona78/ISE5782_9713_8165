...
class MINIP1Tests {
	...
	public void DepthOfFieldTest() {
		...
		scene.setAmbientLight(new AmbientLight(new Color(255, 55, 255), new Double3(0.1)));

		scene.geometries.add( //
				new Plane(new Point(0, -50, 0), new Vector(1, 5, 0)).setEmission(new Color(200, 100, 50)) //
						.setMaterial(new Material().setKd(0.25).setKs(0.25).setShininess(20)),
				new Plane(new Point(0, -50, 0), new Vector(-1, 5, 0)).setEmission(new Color(50, 200, 100)) //
						.setMaterial(new Material().setKd(0.25).setKs(0.25).setShininess(20)),
