...
public class LightsTests {
	...
	private Scene scene_3 = new Scene("Test scene");
	...
	public void MultyObjTransRef4() {
		...
		camera.setImageWriter(imageWriter) //
				.setRayTracerBase(new RayTracerBasic(scene_3)) //
				.renderImage() //
				.writeToImage(); //
	}
	...
	public void MultyObjTransRef10() {
		...
		scene2.lights.add(new PointLight(new Color(200, 0, 0), new Point(0, 0, -50)).setKl(0.0000001).setKq(0.0000001));
