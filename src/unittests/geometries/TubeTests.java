...
class TubeTests {
	...
	public void testFindIntsersections() {
		...
		assertEquals(tube.findIntsersections(new Ray(new Point(-2, 0, 1), new Vector(1, 0, 0))),
		...
		assertEquals(tube.findIntsersections(new Ray(new Point(-2, 0, 0), new Vector(1, 0, 1))),
		...
		assertEquals(tube.findIntsersections(new Ray(new Point(-1, -2, -1), new Vector(0, 1, 1))), intsersections,
				"Test when the ray tangent it failed");

		// TC15: Test when the vertical ray tangent it
		assertEquals(tube.findIntsersections(new Ray(new Point(-1, -2, 0), new Vector(0, 1, 0))), intsersections,
